...
class CommittedPurchasesIndexItem extends React.Component {
  constructor(props) {
    super(props);
  }
      ...
      <div className="wishlist-item-card-container">
        <Card>
          ...
          <CardTitle
            ...
            subtitle={"To be gifted to " + this.props.purchase.wisher.first_name + " " + this.props.purchase.wisher.last_name + " on " + this.props.purchase.wishlist.event_date}/>
...
export default CommittedPurchasesIndexItem;
